...
<c:choose>
	<c:when test="${sessionScope.blAcInfo.getAccountId()==0or sessionScope.blAcInfo.getAccountId()==null }">
	<title>Error!</title>
	</c:when>
	<c:otherwise>
...
<c:choose>
	<c:when test="${sessionScope.blAcInfo.getAccountId()!=0 and sessionScope.blAcInfo.getAccountId() != null}">
