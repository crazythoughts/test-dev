...
<div class="soft-logo">KJJC Soft</div>
	...
	Customer ID: <c:out value="${sessionScope.CustomerDetails.getCustomerId()}"/>
	Name : <c:out value="${sessionScope.CustomerDetails.getCustomerName()}"/>
	Age : <c:out value="${sessionScope.CustomerDetails.getCustomerAge()}"/>
	Sex : <c:out value="${sessionScope.CustomerDetails.getGender()}"/>
	Date of birth : <c:out value="${sessionScope.CustomerDetails.getDob()}"/>
	Nationality : <c:out value="${sessionScope.CustomerDetails.getNationality()}"/>
	Citizenship Number :
	<c:choose>
	...
	<fieldset>
		...
		District : <c:out value="${sessionScope.CustomerDetails.getPermDistrict()}"/>
		Vdc/Municipality : <c:out value="${sessionScope.CustomerDetails.getPermVdcMunicipality()}"/>
	...
	Marital Status : <c:out value="${sessionScope.CustomerDetails.getMaritalStatus()}"/>
	Spouse Name :
	<c:choose>
	...
	Occupation : <c:out value="${sessionScope.CustomerDetails.getOccupation()}"/>
	Father's Name : <c:out value="${sessionScope.CustomerDetails.getFathersName()}"/>
	Grandfather's Name :
	<c:choose>
	...
	Nominee's Name : <c:out value="${sessionScope.CustomerDetails.getNomineesName()}"/>
	Relation : <c:out value="${sessionScope.CustomerDetails.getNomineeRelation()}"/>
	<fieldset>
		<legend>Permanent Address</legend>
		District : <c:out value="${sessionScope.CustomerDetails.getnPermDistrict()}"/>
		Vdc/Municipality : <c:out value="${sessionScope.CustomerDetails.getnPermVdcMunicipality()}"/>
		Other Information :
		<c:choose>
	...
	Joined Date : <c:out value="${sessionScope.CustomerDetails.getjDate()}"/>
	Reffered By :
	<c:choose>
	...
	Approved By : <c:out value="${sessionScope.CustomerDetails.getApprovedBy()}"/>
	Entry By : <c:out value="${sessionScope.CustomerDetails.getEnteredBy() }"/>
	Finger Prints : <img src="/KJJCSoft/upload/<c:out value="${sessionScope.CustomerDetails.getFingerPrintPath()}"/>" height="100px" width="100px"/>
